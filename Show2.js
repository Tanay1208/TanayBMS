...
export default function Show2() {
    ...
    const [obj, setObj] = useState({ selected: 0, label: "A1", show: 2 });
    ...
    useEffect(() => {
        setLoading(true);
        let already= localStorage.getItem("show 2")
       ...
       { !loading &&<div>
            ...
            <div>
                ...
                <Button onClick={()=>{
                    ...
                    localStorage.setItem("Show Details","Show2" );
                    let getData = localStorage.getItem('show 2');
                    localStorage.setItem("show 2",JSON.stringify([obj1,obj2, obj3]))
                    // let fixedData = [];
                    // if(setData){
